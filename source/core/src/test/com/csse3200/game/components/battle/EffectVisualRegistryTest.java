...
class EffectVisualRegistryTest {
  ...
  void laterRegisterForSameTypeReplacesTheEarlierOne() {
    EffectVisualRegistry registry = new EffectVisualRegistry();
    EffectVisualStyle firstAttempt = new EffectVisualStyle(null, Color.RED, 0.3f, 0.4f, 1f, 0f);
  ...
  void rejectsNullType() {
    ...
    assertThrows(IllegalArgumentException.class, () -> registry.register(null, damageStyle));
  }
  ...
  void rejectsNullStyle() {
    ...
    assertThrows(IllegalArgumentException.class, () -> registry.register(EffectType.DAMAGE, null));
  }
}
