...
//    }
    ...
    void shouldApplyBlockToPlayer() {
        ...
        assertEquals(
                5,
                player.getComponent(CombatStatsComponent.class).getArmor());
    }

    @Test
    void shouldApplyImmediateHealToPlayer() {
        CombatStatsComponent stats =
                new CombatStatsComponent(10, 2);
    ...
    void shouldReturnAllLivingEnemiesForEnemyTargetingCard() {
        ...
        List<Entity> targets =
                handler.getLivingEnemyTargets(request, enemies);
...
//    }
    ...
    void shouldReturnNoEnemiesWhenAllEnemiesAreDead() {
        ...
        CardPlayRequest request =
                CardPlayRequest.allEnemies("expose");

        List<Entity> targets =
                handler.getLivingEnemyTargets(
                        request,
