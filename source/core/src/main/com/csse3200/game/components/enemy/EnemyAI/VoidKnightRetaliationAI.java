 ...
 *
 * <p>While armour remains, the knight attacks normally. When its armour is
 * depleted, it performs an empowered retaliation, restores its armour on the
 * following turn, and then returns to its normal attacking state.
 */
    ...
    public EnemyIntent decide(EnemyAIContext context) {
        ...
        if (context.getEnemyArmor() == 0) {
            ...
            return EnemyIntent.attack(
                    context.getEnemyAttack() * RETALIATION_MULTIPLIER);
        }
