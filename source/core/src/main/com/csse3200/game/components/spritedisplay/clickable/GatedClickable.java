 ...
 * progress. Listens to the same "up"/"down" events {@link InOutOnTrigger} hand cards use ("up" when
 * the player's turn begins, "down" the instant the enemy's turn starts, including through the
