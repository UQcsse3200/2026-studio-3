...
public class CardConfig {
  ...
  /**
   * Effects applied when the upgraded version of this card is played. Null means the card has no
   * defined upgrade path and cannot be upgraded. Structured identically to {@link #effects}.
   */
