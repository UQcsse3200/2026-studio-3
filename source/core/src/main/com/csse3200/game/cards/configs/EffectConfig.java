 ...
 * amount of health for HEAL, an amount of restored energy for ENERGY_GAIN, a number of stacks for
 * POISON, VULNERABLE and STRENGTH, and an activation value for CLEANSE. Duration is only used by
 * effects where {@link
