 ...
 * amount of health for HEAL, a number of stacks for POISON, VULNERABLE and STRENGTH, and an
 * activation value for CLEANSE. Duration is only used by effects where {@link
