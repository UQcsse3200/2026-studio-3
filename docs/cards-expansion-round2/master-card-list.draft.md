...
| --- | --- | --- | --- | --- | --- |
| Warding Sweep (proposed) | Hezhenyu (Member 1) | Guardian | Implemented (in config) | DAMAGE; ALL_ENEMIES | In source/core/assets/configs/cards.json: cost 2, ATTACK, COMMON, ALL_ENEMIES, DAMAGE 4. Shipped rarity is COMMON; original design proposed UNCOMMON — flagged for review. |
